 ...
 */
public class ExampleLocalContentAuto : MonoBehaviour, CraftARSDK.CraftARSDKCallbacks, CraftARSDK.CraftARItemEvents {
	...
	void CraftARSDK.CraftARItemEvents.ItemAdded(CraftARItemAR item) {
		//Item added to the ARScene, start tracking and load item content.	
		CraftARSDK.instance.startTracking();
		GameObject content = Resources.Load ("ARItem_"+item.itemName,typeof(GameObject)) as GameObject;
